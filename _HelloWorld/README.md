# Hello World problem as described in [exercism.io retrieved last Feb 17, 2017](http://exercism.io/exercises/python/hello-world/readme) for learning new programming languages
